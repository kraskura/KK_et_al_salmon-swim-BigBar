...
# figures: --------------
# p2.PREDFIT <- ggplot(data= dd_Temp, aes(y=pred.mod, x=Temp_test_mean,
#                                         fill=Species_latin,
...
# p2.PREDFIT
# 
# p2.cmNormMIN<-ggplot(data= data.cmTNorm.use[data.cmTNorm.use$Test_performance2=="Ucrit" ,],
#                      aes(y=SWIM_cms.propMIN, x=Temp_test_mean,
#                             fill=Species_latin,
#                             colour=Species_latin,
#                             shape=SWIM_cms_source,
#                             label=Reference_number_1,
