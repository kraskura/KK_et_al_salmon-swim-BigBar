...
cowplot::plot_grid(cm.all, cm.all.s, 
  ...
  ggsave(filename = "../../ms_exports/Figures/Fig2_cms_order_swim.png",
...
BL.all.s <- ggplot(data=data.BL.rep, aes(x = xi, y = swim_speed_MEAN_BL_s, shape = Species_latin))+
  ...
  scale_shape_manual(breaks = c("Oncorhynchus masou", "Oncorhynchus spp.", "Oncorhynchus keta", "Oncorhynchus tshawytscha",
                                "Oncorhynchus gorbuscha", "Oncorhynchus kisutch", "Oncorhynchus mykiss",  "Oncorhynchus nerka","Salmo salar"),
                     values= c(21,21,  21, 21, 21, 21, 21, 21, 21))+
  xlab('')+ 
...
#                    nrow = 1, ncol=2, 
#                    rel_widths = c(0.5, 1.5)) %>% 
#   ggsave(filename = "../../ms_exports/Figures/FigXX_BLs_order_swim.png",
#          width = 11, height = 6,units = "in")


## Ordered swim speeds BL/s and cm/s together -------
...
## TPC swim | cm.s: species specific --------
...
## TPC swim | BL.s: species specific --------
...
## Swim performance by swim test [cm/s] boxplot --------------
...
## Swim performance by swim test [BL/s] boxplot--------------
